              ...
              القائمة
                  ...
                  <ul class="nav nav-tabs">
                     ...
                     <li>
                        <a href="#">الاقسام</a>
                          <div id="drop-list">
                     <div class="drop-list"><a href="category.php?p=1">كرة القدم</a></div>
                     <div class="drop-list"><a href="category.php?p=2">كرة اليد</a></div>
                     <div class="drop-list"><a href="category.php?p=3">كرة السلة</a></div>
                     <div class="drop-list"><a href="category.php?p=4">رياضات اخرى </a></div>
                     </div><!--drop-list--> 
                     </li>
                  </ul>
            </div>
...
<img src="img/img3.jpg" />
           ...
           <div class="row works">
               ...
               <div class="small-header">
               <h3><a href="category.php?p=5">مقالات</a></h3>
